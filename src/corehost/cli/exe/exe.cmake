...
if(${DOTNET_HOST_EXE_NAME} MATCHES "apphost")
    add_definitions(-DFEATURE_APPHOST=1)
    add_definitions(-DFEATURE_BINDING_CHECK=1)
elseif(${DOTNET_HOST_EXE_NAME} MATCHES "dotnet")
    list(APPEND SOURCES ../../fxr/fx_ver.cpp)
else()
    message(FATAL_ERROR "Unknown host executable name to compile: '${DOTNET_HOST_EXE_NAME}'")
endif()
